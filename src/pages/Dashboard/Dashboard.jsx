  ...
  return (
    ...
    >
      <div>
        ...
        <div className="mt-2 text-3xl font-semibold leading-tight text-slate-50">
          {value}
        </div>
      </div>
      <div
        className={`flex h-11 w-11 items-center justify-center rounded-2xl text-slate-950 ${accent}`}
      >
